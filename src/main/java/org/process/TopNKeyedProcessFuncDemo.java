 ...
 * @Date: 2024/8/4 14:39
 */
public class TopNKeyedProcessFuncDemo {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Tuple3<Integer, Integer, Long>> windowAgg = sensorDS.keyBy((KeySelector<WaterSensor, Integer>) value -> value.getVc())
